...
## Environments
- Preview: https://main--fiscafusca-azmed--aemysites.aem.page/
- Live: https://main--fiscafusca-azmed--aemysites.aem.live/
...
1. Open the `fiscafusca-azmed` directory in your favorite IDE and start coding :)
